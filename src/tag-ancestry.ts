...
export type RunGit = (args: string[]) => void;
 ...
 */
/* v8 ignore start */
export const runGit: RunGit = (args) => {
 ...
 */
export function assertReachableFromMain(sha: string, tagName: string, runGitImpl: RunGit = runGit): void {
    try {
